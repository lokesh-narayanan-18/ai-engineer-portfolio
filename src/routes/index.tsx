...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "Lokesh L — AI/ML Engineer Portfolio" },
      {
        name: "description",
        content:
          "AI/ML Engineer with 2+ years building LLM, RAG and multi-agent systems on Azure. Currently at Tata Consultancy Services.",
      },
      { property: "og:title", content: "Lokesh L — AI/ML Engineer Portfolio" },
      {
        property: "og:description",
        content:
          "Production-grade LLM, RAG and multi-agent AI systems.",
      },
    ],
  }),
  component: Home,
...
const stack = [
  {
    group: "AI / ML",
    items: ["LLMs", "RAG", "NLP", "Multi-Agent AI", "Prompt Engineering", "Text-to-SQL", "Computer Vision"],
  },
  {
    group: "Frameworks",
    items: ["LangChain", "TensorFlow", "HF Transformers", "Scikit-learn"],
  },
  {
    group: "Cloud & Data",
    items: ["Microsoft Azure", "Azure Cosmos DB", "FAISS", "Pinecone", "Chroma", "SQL"],
  },
  {
    group: "Languages",
    items: ["Python", "R", "Java", "C/C++"],
  },
  {
    group: "MLOps & Tools",
    items: ["Docker", "CI/CD", "REST APIs", "Git", "Model Deployment", "JSON Logging"],
  },
];
    ...
    <>
          ...
          <div className="relative z-10 max-w-4xl">
            ...
            <div className="mt-10 flex flex-wrap items-center gap-3">
              ...
              <a
                ...
                download
                className="inline-flex items-center gap-2 rounded-md border border-input bg-background px-5 py-3 text-sm font-medium text-ink transition-colors hover:bg-surface"
              >
              ...
              <Link
                to="/contact"
                className="inline-flex items-center gap-1 px-2 py-3 text-sm font-medium text-ink underline-offset-4 hover:underline"
              >
                Get in touch
              </Link>
            </div>
            ...
            <div className="mt-10 flex flex-wrap items-center gap-6 text-sm text-ink-muted">
              ...
              <a className="inline-flex items-center gap-2 hover:text-ink" href="mailto:lokesh.mass@outlook.com">
                <Mail className="h-4 w-4" /> Email
              </a>
              <a className="inline-flex items-center gap-2 hover:text-ink" href="https://github.com/" target="_blank" rel="noreferrer">
                <Github className="h-4 w-4" /> GitHub
              </a>
              <a className="inline-flex items-center gap-2 hover:text-ink" href="https://www.linkedin.com/" target="_blank" rel="noreferrer">
      ...
      <section className="mx-auto max-w-6xl px-6 py-20 md:py-28">
        ...
        <p className="mt-3 max-w-2xl text-ink-muted">
          The tools I use day-to-day, grouped by where they sit in the stack.
        </p>
        ...
        <div className="mx-auto flex max-w-6xl flex-col items-start justify-between gap-6 px-6 py-16 md:flex-row md:items-center">
          <div>
            ...
            <p className="mt-2 text-ink-muted">
              I'm open to roles, contracts, and interesting collaborations.
            </p>
          </div>
          <Link
            to="/contact"
